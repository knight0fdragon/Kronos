...
Game GameList[NB_STV_GAMES]={
  ...
  },
  {
    ...
    NULL,
    {
        ...
        GAME_WORD_BLOB, "4",   0x1000000, 0x0400000, 0x00000000,
        GAME_WORD_BLOB, "5",   0x1400000, 0x0400000, 0x00000000,
        GAME_WORD_BLOB, "6",   0x1800000, 0x0400000, 0x00000000,
        GAME_WORD_BLOB, "8",   0x1c00000, 0x0400000, 0x00000000,
  ...
  },
  {
    ...
    NV_1P,
    {
        ...
        GAME_WORD_BLOB, "ic34",			0x1000000, 0x200000, 0x00000000,
  ...
  },
  {
    ...
    NV_1P,
    {
        ...
        EEPROM_BLOB,    "prc298sp.nv",		0x0000, 0x0080, 0x00000000,
        GAME_END, "", 0, 0, 0
    },
    STV,
  },
  ...
  },
  {
    ...
    NULL,
    {
        ...
        GAME_WORD_BLOB, "mpr18340.2",    0x0400000, 0x0200000, 0x00000000,
        GAME_END, "", 0, 0, 0
    },
    STV,
  },
  ...
  },
  {
    ...
    NV_1P,
    {
        ...
        GAME_WORD_BLOB,	"mpr-18789.ic8",	0x1c00000, 0x0400000, 0x00000000,
        GAME_WORD_BLOB,	"mpr-18788.ic9",	0x2000000, 0x0400000, 0x00000000,
        EEPROM_BLOB,    "critcrsh.nv",      0x0000, 0x0080, 0x00000000,
        GAME_END, "", 0, 0, 0
    },
    CRITCRSH,
  },
  ...
  },
  {
    ...
    NULL,
    {
        HEADER_BLOB,	"epr17944.13",	0x0000001, 0x0080000, 0x00000000,
        HEADER_BLOB,	"epr17944.13",	0x0100001, 0x0080000, 0x00000000,
        GAME_BYTE_BLOB, "epr17944.13",	0x0200000, 0x0080000, 0x00000000,
        GAME_BYTE_BLOB, "epr17944.13",	0x0300000, 0x0080000, 0x00000000,
