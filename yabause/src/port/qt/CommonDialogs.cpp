...
bool CommonDialogs::error( const QString& m, const QString& c )
...
{ return QMessageBox::question( QApplication::activeWindow(), QtYabause::translate( c ), m, QMessageBox::Ok | QMessageBox::Ignore, QMessageBox::Ok ) == QMessageBox::Ok; }
